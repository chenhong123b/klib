...
public class WebImageCache {
	private static final String DISK_CACHE_PATH = "/klib_image_cache/";
	...
	/**
	 * @param maxSize
	 *            the maxSize to set , default is 5 * 1024 * 1024
	 */
	...
	private void cacheBitmapToMemory(final String url, final Bitmap bitmap) {
		cache.put(getCacheKey(url), bitmap);
	}
